...
class Identity(_BaseMetric):
    ...
    def eval_sequence(self, data):
        ...
        res['IDFN'] = fn_mat[match_rows, match_cols].sum().astype(np.intp)
        res['IDFP'] = fp_mat[match_rows, match_cols].sum().astype(np.intp)
        res['IDTP'] = (gt_id_count.sum() - res['IDFN']).astype(np.intp)
